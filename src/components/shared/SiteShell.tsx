...
/**
 * <html> and <body> of the public site, shared by the root layouts of
 * (webflow) and (ads). The ad landing copies have their own root layout only
 * to get the footer without the service-areas links.
 */
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        ...
        {children}
        <SharedHtmlBlock name="footer" footerAreas={footerAreas} />
        <ScriptLoader />
      </body>
    </html>
  );
